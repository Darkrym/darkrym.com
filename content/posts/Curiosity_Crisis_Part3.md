...
tags:
  ...
  - guide
  - workflow
summary: A hands-on guide to using NotebookLM for cybersecurity learning, including how to create study guides, generate flashcards, and build audio podcasts from technical documentation for active learning.
series:
  - Curiosity Crisis
series_order: 3
---
...
In [Part 1](/posts/curiosity_crisis_part1/), we established that curiosity is a muscle and that AI isn't inherently making us stupider, it's just making our atrophied curiosity more visible. In [Part 2](/posts/curiosity_crisis_part2/), we explored the learning cycle framework and why understanding how learning works matters before using AI as a study tool. Now we get practical.
